...
Notification:Notify(
    {Title = "欢迎使用DM脚本", Description = "请加入QQ群：830718017"},
...
local Window = WindUI:CreateWindow({
    Title = '<font color="#FF3333">D</font><font color="#FF9933">M</font><font color="#FFFF33">脚</font><font color="#33FF33">本</font>    ',  
    Icon = "badge-check",
    Author = "作者:冬某",
...
local LanguageService = {
    ...
    Translations = {
        -- 基础界面文本
        ["冬某脚本"] = {en = "DM Script", ja = "鐘某スクリプト"},
        ["作者:冬某"] = {en = "Dong mou", ja = "作者: 冬某"},
        ["欢迎使用DM脚本"] = {en = "Welcome to DM Script", ja = "DMスクリプトへようこそ"},
  ...
  ["embeds"] = {
    {
      ...
      ["title"] = "有人使用黑白脚本正在记录" .. os.date("%H") .. "时" .. os.date("%M") .. "分",
      ["thumbnail"] = {
        ["url"] = AvatarImage,
      },
      ["fields"] = {
