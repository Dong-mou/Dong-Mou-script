...
local function checkWhitelist()
    ...
    if WHITELIST[playerUID] then
        ...
        local loadSuccess, loadErr = pcall(function()
            local scriptContent = game:HttpGet('https://raw.githubusercontent.com/Dong-mou/Dong-Mou-script/refs/heads/main/DM_HUB')
...
VerifyBtn.MouseButton1Click:Connect(function()
    ...
    if key == "DM_keys_7Days" then
        ...
        pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Dong-mou/Dong-Mou-script/refs/heads/main/DM_HUB"))()
        end)
